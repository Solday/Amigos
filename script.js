...
//Leer el contenido de nuestro HTML al que le dimos click y extraer la info del cafe
function leerInfo(producto) {
    //Crear un objeto con el contenido del cafe
    const infoProducto = {
